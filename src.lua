...
if (game:GetService("CoreGui")):FindFirstChild("AzureLibCloudHub") or (game:GetService("CoreGui")):FindFirstChild("InsertedObjects") or (game:GetService("CoreGui")):FindFirstChild("WeAllKnowCloudHubOnTop") then
    game.StarterGui:SetCore("SendNotification", {
        Title = "Cloud Hub", Text = "Cloud Hub Already Running.", Duration = 3
    })
else
    wait(1)
    ...
    UpperLine.BackgroundTransparency = 1
    ...
    if game.PlaceId == 301549746 then
        ...
        if (game:GetService("CoreGui")):FindFirstChild("InsertedObjects") then
            ...
            local b = syn and "Synapse X"
            if b then
                game.StarterGui:SetCore("SendNotification", {
                    Title = "Cloud Hub", Text = "Using: " .. b, Duration = 3
                })
                local c = (loadstring(game:HttpGet("https://pastebin.com/raw/04mPGecU")))()
                local d = {
                    circleTransparency = 0, drawCircle = false, circleRadius = 50, circleNumSides = 10
                }
                checkisTeam = false
                getAimPart = "Head"
                ...
                function CheckRay2(i, j, k, l)
                    ...
                    local p = {
                        game.Players.LocalPlayer.Character, workspace.CurrentCamera, game.Players.LocalPlayer:GetMouse().TargetFilter
                    }
                    ...
                    if s and not s:IsDescendantOf(n) then
                        m = false
                        if s.Transparency >= 0.3 or not s.CanCollide and s.ClassName ~= Terrain then
                            h[#h + 1] = s
                        end
                    end
                    return m
                            ...
                            if A ~= game:GetService("Players").LocalPlayer and game:GetService("Players").LocalPlayer.Character and A.Character and A.Character:FindFirstChild(getAimPart) then
                                if game:GetService("Players").LocalPlayer.Character:FindFirstChild(getAimPart) then
                                    ...
                                    if checkIfObscured then
                                        local C = {
                                            game:GetService("Players").LocalPlayer.Character, A.Character
                                        }
                                        local D = {
                                            game:GetService("Players").LocalPlayer.Character[getAimPart].Position, A.Character[getAimPart].Position
                                        }
                ...
                function aA:AddOrUpdateInstance(aB, aC, aD, aE)
                    aA.Instances[aB] = {
                        ParentInstance = aB, Instance = aC, Text = aD, Color = aE
                    }
                            ...
                            if workspace:FindFirstChild("MoneyPrinters") then
                                for af, al in pairs(workspace.MoneyPrinters:GetChildren()) do
                                    ...
                                    if aK and aL and aM then
                                        ...
                                        pcall(aA.AddOrUpdateInstance, aA, al, aK, string.format("Money Printer\10Owned by %s\10[%s]", aN, aO), Color3.fromRGB(13, 255, 227))
                                    end
                                end
                            end
                        end
                ...
                function CalculateValue(b1, b2, b3)
                    return b1 + math.floor((b2 - b1) * b3 + 0.5)
                end
                ...
                local b6 = setmetatable({}, {
                    __call = function(ae, ...)
                        ...
                        rawset(ae, aP, setmetatable({
                            Name = b7[1], Text = b7[2], Value = b7[3], DefaultValue = b7[3], AllArgs = b7, Index = _
                        }, {
                ...
                function a0:Create(b5)
                    ...
                    local b5 = be({
                        Transparency = 1, Thickness = 1, Visible = true
                    }, b5)
                ...
                function CheckRay(aB, bt, bu, bv)
                    ...
                    if bA and not bA:IsDescendantOf(bx) then
                        bw = false
                        if bA.Transparency >= 0.3 or not bA.CanCollide and bA.ClassName ~= Terrain then
                            a7[#a7 + 1] = bA
                        end
                    end
                    return bw
                ...
                c0:CreateToggle({
                    text = "Enabled", callback = function(c7)
                        if c7 then
                            accaaambot = true
                        else
                            accaaambot = false
                ...
                c0:CreateToggle({
                    text = "Check Visible", callback = function(c9)
                        aimVisibleCheck = c9
                    end
                })
                c0:CreateToggle({
                    text = "Team Check", callback = function(c9)
                        checkisTeam = c9
                    end
                })
                c0:CreateSlider({
                    text = "Smoothness", bind = "Aimbot-Smoothness", minval = 0, maxval = 6, callback = function(ca)
                        if ca == 6 then
                            a.XPos = 0.1
                        elseif ca == 5 then
                            a.XPos = 0.2
                ...
                local cb = {
                    isEnabled = false, Holding = false, Delay = 0
                }
                ...
                c1:CreateToggle({
                    text = "Enabled", callback = function(cd)
                        cb.isEnabled = cd
                    end
                })
                c1:CreateSlider({
                    text = "Delay", bind = "Trigger-Delay", minval = 0, maxval = 100, callback = function(ce)
                        cb.Delay = ce / 100
                    end
                })
                d.circleRadius = 50
                ...
                c2:CreateSlider({
                    text = "Transparency", bind = "Circle-Transparency", minval = 0, maxval = 50, callback = function(ci)
                        d.circleTransparency = ci / 100
                    end
                })
                c2:CreateSlider({
                    text = "Radius", bind = "Circle-Radius", minval = 50, maxval = 500, callback = function(cj)
                        d.circleRadius = cj
                    end
                })
                d.circleNumSides = 10
                c2:CreateSlider({
                    text = "NumSides", bind = "Circle-NumSides", minval = 10, maxval = 100, callback = function(ck)
                        d.circleNumSides = ck
                    end
                })
                c4:CreateToggle({
                    text = "Enabled", callback = function(cl)
                        b6.Enabled = cl
                    end
                })
                c4:CreateToggle({
                    text = "Show Boxes", callback = function(cl)
                        b6.ShowBoxes = cl
                    end
                })
                c4:CreateToggle({
                    text = "Show Tracers", callback = function(cl)
                        b6.ShowTracers = cl
                    end
                })
                if not is_sirhurt_closure then
                    c4:CreateToggle({
                        text = "Show Names", callback = function(cl)
                            b6.ShowName = cl
                        end
                    })
                    c4:CreateToggle({
                        text = "Show Distance", callback = function(cl)
                            b6.ShowDistance = cl
                        end
                    })
                end
                c5:CreateToggle({
                    text = "Show Team", callback = function(cl)
                        b6.ShowTeam = cl
                    end
                })
                c5:CreateToggle({
                    text = "Show Team-Color", callback = function(cl)
                        b6.ShowTeamColor = cl
                    end
                })
                c6:CreateSlider({
                    text = "Max Distance", bind = "Max-Distance", minval = 250, maxval = 2500, callback = function(cm)
                        b6.MaxDistance = cm
                    end
                })
                c6:CreateToggle({
                    text = "Check Visible", callback = function(cl)
                        b6.VisCheck = cl
                    end
                })
                ...
                co:CreateToggle({
                    text = "Legit Silent Aimbot", callback = function(cl)
                        hitboxSettings.isEnabled = cl
                    end
                })
                co:CreateSlider({
                    text = "Silent Aimbot FOV", bind = "sa-fov", minval = 5, maxval = 50, callback = function(cq)
                ...
                cr:CreateButton({
                    text = "No Recoil", callback = function()
                ...
                cr:CreateButton({
                    text = "No FireRate", callback = function()
                ...
                cr:CreateSlider({
                    text = "Ammo", bind = "Ammo-Value", minval = 30, maxval = 999999, callback = function(ct)
                        for z, A in pairs(game:GetService("ReplicatedStorage").Weapons:GetDescendants()) do
                ...
                cv:CreateToggle({
                    text = "Infinite Jump", callback = function(ct)
                        infinitejumpenabled = ct
                    end
                })
                cv:CreateButton({
                    text = "No FallDamage", callback = function()
                ...
                cv:CreateButton({
                    text = "Remove Smoke", callback = function()
                        while wait() do
                ...
                cA:CreateButton({
                    text = "1temz#7830", callback = function()
                    end
                })
                cA:CreateButton({
                    text = "prezt#2918", callback = function()
                    end
                })
                cA:CreateButton({
                    text = "Copy Discord Link", callback = function()
                ...
                cB:CreateToggle({
                    text = "Encrpyt Informations", callback = function(ct)
                        if ct then
                ...
                cI:CreateBind({
                    text = "Hide / Show", key = "RightShift", callback = function()
    ...
    elseif game.PlaceId == 155615604 then
        ...
        if (game:GetService("CoreGui")):FindFirstChild("InsertedObjects") then
            ...
            if b then
                ...
                co:CreateButton({
                    text = "Prison In", callback = function()
                ...
                co:CreateButton({
                    text = "Prison Yard", callback = function()
                ...
                co:CreateButton({
                    text = "Prison Out", callback = function()
                ...
                co:CreateButton({
                    text = "Cafeteria", callback = function()
                ...
                cp:CreateButton({
                    text = "Criminal Garage", callback = function()
                ...
                cp:CreateButton({
                    text = "City Garage", callback = function()
                ...
                cp:CreateButton({
                    text = "Prison Garage", callback = function()
                ...
                cq:CreateButton({
                    text = "Criminal Base", callback = function()
                ...
                cq:CreateButton({
                    text = "Guard Base", callback = function()
                ...
                ct:CreateButton({
                    text = "Remington 870", callback = function()
                ...
                ct:CreateButton({
                    text = "Crude Knife", callback = function()
                ...
                ct:CreateButton({
                    text = "Take Dropped KeyCard", callback = function()
                ...
                ct:CreateButton({
                    text = "All Guns", callback = function()
                ...
                cw:CreateButton({
                    text = "No Range", callback = function()
                ...
                cw:CreateButton({
                    text = "More Bullet", callback = function()
                        for z, A in pairs(getgc(true)) do
                ...
                cw:CreateButton({
                    text = "No Spread", callback = function()
                        for z, A in pairs(getgc(true)) do
                ...
                cw:CreateButton({
                    text = "No Fire-Rate", callback = function()
                        for z, A in pairs(getgc(true)) do
                ...
                cw:CreateButton({
                    text = "Fast Reload", callback = function()
                        for z, A in pairs(getgc(true)) do
                ...
                cw:CreateButton({
                    text = "Infinite Ammo", callback = function()
                        for z, A in pairs(getgc(true)) do
                ...
                cw:CreateButton({
                    text = "Automatic Gun", callback = function()
                        for z, A in pairs(getgc(true)) do
                            if type(A) == "table" and rawget(A, "MaxAmmo") then
                                A.AutoFire = true
                                A.Damage = 200
                ...
                onePunchman = false
                cx:CreateToggle({
                    text = "One Punch Man", callback = function(cy)
                        onePunchman = cy
                ...
                cx:CreateToggle({
                    text = "Kill Criminals", callback = function(cy)
                        if cy == true then
                            ...
                            while _G.CriminalKill do
                                ...
                                function kill(f)
                                    local L = {
                                        [1] = {
                                            RayObject = Ray.new(Vector3.new(845.555908, 101.429337, 2269.43945), Vector3.new(-391.152252, 8.65560055, -83.2166901)), Distance = 3.2524313926697, Cframe = CFrame.new(840.310791, 101.334137, 2267.87988, 0.0636406094, 0.151434347, -0.986416459, 0, 0.988420188, 0.151741937, 0.997972965, -0.00965694897, 0.0629036576), Hit = f.Character.Head
                                        }, [2] = {
                                            RayObject = Ray.new(Vector3.new(845.555908, 101.429337, 2269.43945), Vector3.new(-392.481476, -8.44939327, -76.7261353)), Distance = 3.2699294090271, Cframe = CFrame.new(840.290466, 101.184189, 2267.93506, 0.0964837447, 0.0589403138, -0.993587971, 4.65661287e-10, 0.998245299, 0.0592165813, 0.995334625, -0.00571343815, 0.0963144377), Hit = f.Character.Head
                                        }, [3] = {
                                            RayObject = Ray.new(Vector3.new(845.555908, 101.429337, 2269.43945), Vector3.new(-389.21701, -2.50536323, -92.2163162)), Distance = 3.1665518283844, Cframe = CFrame.new(840.338867, 101.236496, 2267.80371, 0.0166504811, 0.0941716284, -0.995416701, 1.16415322e-10, 0.995554805, 0.0941846818, 0.999861419, -0.00156822044, 0.0165764652), Hit = f.Character.Head
                                        }, [4] = {
                                            RayObject = Ray.new(Vector3.new(845.555908, 101.429337, 2269.43945), Vector3.new(-393.353973, 3.13988972, -72.5452042)), Distance = 3.3218522071838, Cframe = CFrame.new(840.277222, 101.285957, 2267.9707, 0.117109694, 0.118740402, -0.985994935, -1.86264515e-09, 0.992826641, 0.119563118, 0.993119001, -0.0140019981, 0.116269611), Hit = f.Character.Head
                                        }, [5] = {
                                            RayObject = Ray.new(Vector3.new(845.555908, 101.429337, 2269.43945), Vector3.new(-390.73172, 3.2097764, -85.5477524)), Distance = 3.222757101059, Cframe = CFrame.new(840.317993, 101.286423, 2267.86035, 0.0517584644, 0.123365127, -0.991010666, 0, 0.992340803, 0.123530701, 0.99865967, -0.00639375951, 0.0513620302), Hit = f.Character.Head
                                        }
                                    }
                ...
                cx:CreateToggle({
                    text = "Kill Prisoners", callback = function(cy)
                        if cy == true then
                ...
                cx:CreateToggle({
                    text = "Kill Guards", callback = function(cy)
                        if cy == true then
                            _G.GuardKill = true
                ...
                cx:CreateToggle({
                    text = "Tase All", callback = function(cy)
                        if cy == true then
                            _G.tazeall = true
                            while _G.tazeall do
                                function kill(f)
                                    local L = {
                                        [1] = {
                                            RayObject = Ray.new(Vector3.new(829.838562, 101.489998, 2331.25635), Vector3.new(-30.6540909, -5.42795324, 95.0308533)), Distance = 15.355997085571, Cframe = CFrame.new(826.616699, 100.8508, 2340.11279, 0.964640439, -0.00993416365, -0.263382077, 9.31322575e-10, 0.999289393, -0.0376908854, 0.263569355, 0.0363581516, 0.963954985), Hit = f.Character.Torso
                                        }
                                    }
                ...
                cx:CreateToggle({
                    text = "Kill Aura", callback = function(cy)
                        if cy == true then
                            _G.killaura = true
                            mainRemotes = game.ReplicatedStorage
                            meleeRemote = mainRemotes.meleeEvent
                ...
                cx:CreateButton({
                    text = "Arrest All", callback = function()
                ...
                cA:CreateSlider({
                    text = "WalkSpeed", bind = "C-Walkspeed", minval = 16, maxval = 200, callback = function(cy)
                        game:GetService("Players").LocalPlayer.Character.Humanoid.WalkSpeed = cy
                    end
                })
                cA:CreateSlider({
                    text = "JumpPower", bind = "C-JumpPower", minval = 50, maxval = 250, callback = function(cy)
                        game:GetService("Players").LocalPlayer.Character.Humanoid.JumpPower = cy
                    end
                })
                cA:CreateDropdown({
                    text = "Change Team", list = {
                        "Inmute", "Criminal", "Guard", "Neutral"
                    }, callback = function(c8)
                        if c8 == "Inmute" then
                            Workspace.Remote.TeamEvent:FireServer("Bright orange")
                ...
                cA:CreateToggle({
                    text = "Infinite Jump", callback = function(cy)
                        infinitejumpenabled = cy
                    end
                })
                cA:CreateToggle({
                    text = "No Clip", callback = function(cy)
                        if cy then
                            _G.noclipthink = true
                            game:GetService("RunService").Stepped:connect(function()
                ...
                cA:CreateButton({
                    text = "Fast Respawn", callback = function()
                ...
                cE:CreateButton({
                    text = "Delete Doors", callback = function()
                ...
                cE:CreateButton({
                    text = "Delete Fances", callback = function()
                ...
                cH:CreateToggle({
                    text = "Encrpyt Informations", callback = function(cy)
                        if cy then
    ...
    elseif game.PlaceId == 286090429 then
        ...
        if (game:GetService("CoreGui")):FindFirstChild("InsertedObjects") then
            ...
            if b then
                ...
                co:CreateToggle({
                    text = "WallBang", callback = function(cq)
                        cp.isEnabled = cq
                ...
                co:CreateSlider({
                    text = "Silent Aimbot FOV", bind = "sa-fov", minval = 5, maxval = 50, callback = function(cv)
                ...
                local cx
                local cy = {
                    noRecoil = false, noSpread = false, noFireRate = false, fastReload = false, infiniteAmmo = false, automaticGun = false
                }
                ...
                cz:CreateToggle({
                    text = "No Recoil", callback = function(cA)
                        cy.noRecoil = cA
                    end
                })
                cz:CreateToggle({
                    text = "No Spread", callback = function(cA)
                        cy.noSpread = cA
                    end
                })
                cz:CreateToggle({
                    text = "No Fire-Rate", callback = function(cA)
                        cy.noFireRate = cA
                    end
                })
                cz:CreateToggle({
                    text = "Fast Reload", callback = function(cA)
                        cy.fastReload = cA
                    end
                })
                cz:CreateToggle({
                    text = "Infinite Ammo", callback = function(cA)
                        cy.infiniteAmmo = cA
                    end
                })
                cz:CreateToggle({
                    text = "Automatic Gun", callback = function(cA)
                        cy.automaticGun = cA
                    end
                })
                ...
                local cC = {
                    killAura = false, killAuraDist = 10, damageDelay = 0
                }
                cB:CreateToggle({
                    text = "Kill Aura", callback = function(cD)
                        cC.killAura = cD
                ...
                cB:CreateSlider({
                    text = "Kill Aura Distance", bind = "Kill-Aura-Distance", minval = 10, maxval = 250, callback = function(cA)
                        cC.killAuraDist = tonumber(cA)
                    end
                })
                cB:CreateSlider({
                    text = "Damage Delay", bind = "Kill-Aura-Delay", minval = 0, maxval = 100, callback = function(cA)
                ...
                cI:CreateToggle({
                    text = "Infinite Jump", callback = function(cA)
                        infinitejumpenabled = cA
                    end
                })
                cI:CreateToggle({
                    text = "No Clip", callback = function(cA)
                        if cA then
                            _G.noclipthink = true
                            game:GetService("RunService").Stepped:connect(function()
                                if _G.noclipthink then
                ...
                cO:CreateToggle({
                    text = "Encrpyt Informations", callback = function(cA)
                        if cA then
    ...
    elseif game.PlaceId == 443406476 then
        if (game:GetService("CoreGui")):FindFirstChild("AzureLibCloudHub") then
            game.StarterGui:SetCore("SendNotification", {
                Title = "CloudHub Hub", Text = "Already Open.", Duration = 5
            })
        end
        if (game:GetService("RunService")):IsStudio() then
            game:GetService("Players").LocalPlayer:Kick("Cloud Secure Blocking You! Reason: Trying to Open CloudHub in Studio")
            ...
            _G.CustomTheme = {
                Tab_Color = Color3.fromRGB(25, 25, 25), Tab_Text_Color = Color3.fromRGB(241, 134, 255), Description_Color = Color3.fromRGB(25, 25, 25), Description_Text_Color = Color3.fromRGB(241, 134, 255), Container_Color = Color3.fromRGB(25, 25, 25), Container_Text_Color = Color3.fromRGB(255, 255, 255), Button_Text_Color = Color3.fromRGB(255, 255, 255), Toggle_Box_Color = Color3.fromRGB(255, 92, 92), Toggle_Inner_Color = Color3.fromRGB(105, 255, 107), Toggle_Text_Color = Color3.fromRGB(255, 255, 255), Toggle_Border_Color = Color3.fromRGB(35, 35, 35), Slider_Bar_Color = Color3.fromRGB(25, 25, 25), Slider_Inner_Color = Color3.fromRGB(241, 134, 255), Slider_Text_Color = Color3.fromRGB(255, 255, 255), Slider_Border_Color = Color3.fromRGB(35, 35, 35), 
                Dropdown_Text_Color = Color3.fromRGB(255, 255, 255), Dropdown_Option_BorderSize = 1, Dropdown_Option_BorderColor = Color3.fromRGB(49, 50, 51), Dropdown_Option_Color = Color3.fromRGB(25, 25, 25), Dropdown_Option_Text_Color = Color3.fromRGB(205, 205, 205)
            }
            local a = syn and "Synapse X"
            if a then
                game.StarterGui:SetCore("SendNotification", {
                    Title = "CloudHub Hub", Text = "Using: " .. a, Duration = 3
                })
                if mousemoverel then
                    local c = (loadstring(game:HttpGet("https://raw.githubusercontent.com/1temz/cloudhub/master/library.lua", true)))()
                    local d = c:CreateTab("Teleports", "Teleports.")
                    d:CreateDropDown("Locations", {
                        "Library", "Bathroom", "PowerPlace", "Spawn", "CenterYard", "BuildingTop"
                    }, function(e)
                        if e == "Library" then
                    ...
                    local f = c:CreateTab("Misc", "Miscellaneous")
                    f:CreateButton("Active Power", function()
                    ...
                    f:CreateToggle("Annoy Players", function(k)
                        if k == true then
                    ...
                    f:CreateToggle("Full Bright", function(k)
                        if k == true then
                            if not _G.FullBrightoExecuted then
                                _G.FullBrightEnabledo = false
                                _G.NormalLightingSettings = {
                                    Brightness = game:GetService("Lighting").Brightness, ClockTime = game:GetService("Lighting").ClockTime, FogEnd = game:GetService("Lighting").FogEnd, GlobalShadows = game:GetService("Lighting").GlobalShadows, Ambient = game:GetService("Lighting").Ambient
                                }
                    ...
                    y:CreateToggle("[PLR] Box ESP", function(J)
                        if J then
                            local n = Instance.new("Folder", game.CoreGui)
                    ...
                    y:CreateToggle("[Zombie] Box ESP", function(k)
                        if k == true then
                    ...
                    local U = c:CreateTab("Combat", "features about combat & fight.")
                    U:CreateButton("Modify Gun", function()
                    ...
                    U:CreateButton("Bring Zombies [T]", function()
                    ...
                    local W = c:CreateTab("LocalPlayer", "features about local player.")
                    W:CreateSlider("WalkSpeed", 16, 150, function(e)
                        game.Players.LocalPlayer.Character.Humanoid.WalkSpeed = e
                    end)
                    W:CreateToggle("No-Clip", function(k)
                        if k == true then
                            _G.noclipthink = true
                            game:GetService("RunService").Stepped:connect(function()
                                if _G.noclipthink then
                    ...
                    local X = c:CreateTab("Info", "Credits & Extra Info")
                    X:CreateButton("CloudHub:tm:", function()
                        if setclipboard then
                            setclipboard("discord.gg/EAFYPZn")
                        end
                    end)
                    X:CreateButton("Lib: Azure Library", function()
                        if setclipboard then
                            setclipboard("discord.gg/EAFYPZn")
                        end
                    end)
                    X:CreateButton("Script: 1temz#7830", function()
                        if setclipboard then
                            setclipboard("discord.gg/EAFYPZn")
                        end
                    end)
                    X:CreateButton("discord.gg/EAFYPZn", function()
                        if setclipboard then
                            setclipboard("discord.gg/EAFYPZn")
                        end
                    end)
                    X:CreateButton("Right Shift For Hide / Show", function()
                    end)
                    local Y = game:GetService("UserInputService")
                    Y.InputBegan:connect(function(Z, _)
                        if Z.KeyCode == Enum.KeyCode.RightShift then
                            if game:GetService("CoreGui").AzureLibCloudHub.Enabled == true then
                                game:GetService("CoreGui").AzureLibCloudHub.Enabled = false
                            elseif game:GetService("CoreGui").AzureLibCloudHub.Enabled == false then
                                game:GetService("CoreGui").AzureLibCloudHub.Enabled = true
                            end
                        end
                    end)
                    plr = game.Players.LocalPlayer
                    mouse = plr:GetMouse()
                    mouse.KeyDown:connect(function(a0)
                        if a0 == "t" then
                            local T = workspace.Baddies:GetChildren()
                            for G = 1, #T do
                                T[G].HeadBox.Transparency = 0
    ...
    elseif game.PlaceId == 2317712696 then
        ...
        if (game:GetService("CoreGui")):FindFirstChild("InsertedObjects") then
            ...
            if b then
                ...
                co:CreateSlider({
                    text = "Silent Aimbot FOV", bind = "sa-fov", minval = 5, maxval = 50, callback = function(cp)
                ...
                cs:CreateButton({
                    text = "Always Day", callback = function()
                ...
                cw:CreateToggle({
                    text = "Encrpyt Informations", callback = function(cD)
                        if cD then
    ...
    elseif game.PlaceId == 3101667897 then
        ...
        if (game:GetService("CoreGui")):FindFirstChild("InsertedObjects") then
            ...
            if b then
                ...
                local cp = {
                    stepFarm = false, xpFarm = false, gemFarm = false, autoRebirht = false, stepFarmDelay = 0, xpFarmDelay = 0, gemFarmDelay = 0
                }
                game:GetService("RunService").Stepped:Connect(function()
                    spawn(function()
                        if cp.stepFarm then
                ...
                co:CreateToggle({
                    text = "Step Farm", callback = function(cz)
                        cp.stepFarm = cz
                    end
                })
                co:CreateToggle({
                    text = "XP Farm", callback = function(cz)
                        cp.xpFarm = cz
                    end
                })
                co:CreateToggle({
                    text = "Gem Farm", callback = function(cz)
                        cp.gemFarm = cz
                    end
                })
                co:CreateToggle({
                    text = "Auto Rebirth", callback = function(cz)
                        cp.autoRebirht = cz
                    end
                })
                ...
                cA:CreateSlider({
                    text = "Step Farm Delay", bind = "sf-delay", minval = 0, maxval = 100, callback = function(cz)
                        cp.stepFarmDelay = cz / 100
                    end
                })
                cA:CreateSlider({
                    text = "XP Farm Delay", bind = "xpf-delay", minval = 0, maxval = 100, callback = function(cz)
                        cp.xpFarmDelay = cz / 100
                    end
                })
                cA:CreateSlider({
                    text = "Gem Farm Delay", bind = "gf-delay", minval = 0, maxval = 100, callback = function(cz)
                ...
                cC:CreateToggle({
                    text = "Infinite Jump", callback = function(cG)
                        infinitejumpenabled = cG
                    end
                })
                cC:CreateToggle({
                    text = "No Clip", callback = function(cG)
                        if cG then
                            _G.noclipthink = true
                            game:GetService("RunService").Stepped:connect(function()
                                if _G.noclipthink then
                ...
                cJ:CreateToggle({
                    text = "Encrpyt Informations", callback = function(cG)
                        if cG then
    ...
    elseif game.PlaceId == 621129760 then
        ...
        if (game:GetService("CoreGui")):FindFirstChild("InsertedObjects") then
            ...
            if b then
                ...
                c0:CreateToggle({
                    text = "Enabled", callback = function(c6)
                        if c6 then
                            accaaambot = true
                        else
                            accaaambot = false
                ...
                c0:CreateToggle({
                    text = "Check Visible", callback = function(c8)
                        aimVisibleCheck = c8
                    end
                })
                c0:CreateToggle({
                    text = "Team Check", callback = function(c8)
                        checkisTeam = c8
                    end
                })
                c0:CreateSlider({
                    text = "Smoothness", bind = "Aimbot-Smoothness", minval = 0, maxval = 6, callback = function(c9)
                        if c9 == 6 then
                            a.XPos = 0.1
                        elseif c9 == 5 then
                            a.XPos = 0.2
                ...
                c1:CreateToggle({
                    text = "Enabled", callback = function(cc)
                        ca.isEnabled = cc
                    end
                })
                c1:CreateSlider({
                    text = "Delay", bind = "Trigger-Delay", minval = 0, maxval = 100, callback = function(cd)
                        ca.Delay = cd / 100
                    end
                })
                d.circleRadius = 50
                ...
                c2:CreateSlider({
                    text = "Transparency", bind = "Circle-Transparency", minval = 0, maxval = 50, callback = function(ch)
                        d.circleTransparency = ch / 100
                    end
                })
                c2:CreateSlider({
                    text = "Radius", bind = "Circle-Radius", minval = 50, maxval = 500, callback = function(ci)
                        d.circleRadius = ci
                    end
                })
                d.circleNumSides = 10
                c2:CreateSlider({
                    text = "NumSides", bind = "Circle-NumSides", minval = 10, maxval = 100, callback = function(cj)
                        d.circleNumSides = cj
                    end
                })
                c4:CreateToggle({
                    text = "Enabled", callback = function(ck)
                        b6.Enabled = ck
                    end
                })
                c4:CreateToggle({
                    text = "Show Boxes", callback = function(ck)
                        b6.ShowBoxes = ck
                    end
                })
                c4:CreateToggle({
                    text = "Show Tracers", callback = function(ck)
                        b6.ShowTracers = ck
                    end
                })
                c4:CreateToggle({
                    text = "Show Names", callback = function(ck)
                        b6.ShowName = ck
                    end
                })
                c4:CreateToggle({
                    text = "Show Distance", callback = function(ck)
                        b6.ShowDistance = ck
                    end
                })
                b6.ShowTeam = true
                ...
                c5:CreateSlider({
                    text = "Max Distance", bind = "Max-Distance", minval = 250, maxval = 2500, callback = function(cl)
                        b6.MaxDistance = cl
                    end
                })
                c5:CreateToggle({
                    text = "Check Visible", callback = function(ck)
                        b6.VisCheck = ck
                    end
                })
                ...
                SilentAimbot = {
                    isEnabled = false, useFov = false, hitPart = "Head", hitChance = 100
                }
                ...
                cn:CreateSlider({
                    text = "Hit Chance %", minval = 100, maxval = 0, callback = function(c7)
                ...
                local cz = {
                    NoFireRate = false, InfiniteAmmo = false
                }
                cy:CreateToggle({
                    text = "No-FireRate", callback = function(c7)
                        cz.NoFireRate = c7
                        while cz.NoFireRate do
                            for z, A in pairs(getgc(true)) do
                                if type(A) == "table" and rawget(A, "FireDelay") then
                                    A.FireDelay = -9000000000
                                end
                            end
                            wait(2)
                        end
                ...
                cB:CreateToggle({
                    text = "Infinite Jump", callback = function(cF)
                        infinitejumpenabled = cF
                    end
                })
                cB:CreateSlider({
                    text = "Field Of View", minval = 70, maxval = 150, callback = function(c7)
                ...
                cI:CreateToggle({
                    text = "Encrpyt Informations", callback = function(cF)
                        if cF then
                            game:GetService("Players").LocalPlayer.UserId = cK
                            game:GetService("Players").LocalPlayer.DisplayName = cM
                            game:GetService("Players").LocalPlayer.Name = cO
    ...
    elseif game.PlaceId == 662417684 then
        if (game:GetService("CoreGui")):FindFirstChild("AzureLibCloudHub") then
            ...
            _G.CustomTheme = {
                Tab_Color = Color3.fromRGB(25, 25, 25), Tab_Text_Color = Color3.fromRGB(241, 134, 255), Description_Color = Color3.fromRGB(25, 25, 25), Description_Text_Color = Color3.fromRGB(241, 134, 255), Container_Color = Color3.fromRGB(25, 25, 25), Container_Text_Color = Color3.fromRGB(255, 255, 255), Button_Text_Color = Color3.fromRGB(255, 255, 255), Toggle_Box_Color = Color3.fromRGB(25, 25, 25), Toggle_Inner_Color = Color3.fromRGB(241, 134, 255), Toggle_Text_Color = Color3.fromRGB(255, 255, 255), Toggle_Border_Color = Color3.fromRGB(35, 35, 35), Slider_Bar_Color = Color3.fromRGB(25, 25, 25), Slider_Inner_Color = Color3.fromRGB(241, 134, 255), Slider_Text_Color = Color3.fromRGB(255, 255, 255), Slider_Border_Color = Color3.fromRGB(35, 35, 35), 
                Dropdown_Text_Color = Color3.fromRGB(255, 255, 255), Dropdown_Option_BorderSize = 1, Dropdown_Option_BorderColor = Color3.fromRGB(49, 50, 51), Dropdown_Option_Color = Color3.fromRGB(25, 25, 25), Dropdown_Option_Text_Color = Color3.fromRGB(205, 205, 205)
            }
            local e = syn and "Synapse X"
            if e then
                game.StarterGui:SetCore("SendNotification", {
                    Title = "Cloud Hub", Text = "Using: " .. e, Duration = 3
                })
                local f = (loadstring(game:HttpGet("https://raw.githubusercontent.com/1temz/cloudhub/master/library.lua", true)))()
                            ...
                            if k.Character and k.Character:FindFirstChild("HumanoidRootPart") and k.Character and (_G.SHOWTRACERS or _G.SHOWNAMES or _G.SHOWPLAYERINS or _G.SHOWPLAYER) and k.Name ~= game.Players.LocalPlayer.Name then
                                ...
                                if _G.SHOWNAMES then
                                    if q[k.Name][3] then
                                        ...
                                        q[k.Name][3].Text = k.Name .. "\10" .. tostring(math.floor((game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position - k.Character.HumanoidRootPart.Position).magnitude))
                ...
                local C = f:CreateTab("Visual", "New Drawing ESP")
                _G.SHOWPLAYER = false
                _G.SHOWPLAYERINS = false
                _G.SHOWTRACERS = false
                _G.SHOWNAMES = false
                C:CreateToggle("Box ESP", function(D)
                    _G.SHOWPLAYER = D
                    _G.SHOWPLAYERINS = D
                end)
                C:CreateToggle("Tracers", function(D)
                    _G.SHOWTRACERS = D
                end)
                local E = f:CreateTab("Farming", "Farming")
                E:CreateButton("Diamond Block", function()
                    game.ReplicatedStorage.SpawnDiamondBlock:FireServer()
                end)
                E:CreateButton("Super Block", function()
                    game.ReplicatedStorage.SpawnDiamondBlock:FireServer()
                end)
                E:CreateButton("Rainbow Block", function()
                    game.ReplicatedStorage.SpawnRainbowBlock:FireServer()
                end)
                E:CreateButton("Galaxy Block", function()
                    game.ReplicatedStorage.SpawnGalaxyBlock:FireServer()
                end)
                E:CreateButton("All Gears", function()
                    for F = 1, 50 do
                        game.ReplicatedStorage.SpawnGalaxyBlock:FireServer()
                    end
                end)
                local G = f:CreateTab("LocalPlayer", "features about you!")
                G:CreateSlider("WalkSpeed", 16, 150, function(H)
                    game.Players.LocalPlayer.Character.Humanoid.WalkSpeed = H
                end)
                G:CreateSlider("JumpPower", 50, 200, function(H)
                    game.Players.LocalPlayer.Character.Humanoid.JumpPower = H
                end)
                G:CreateToggle("Infinite Jump", function(H)
                    infinitejumpenabled = H
                end)
                G:CreateToggle("No-Clip", function(I)
                    if I == true then
                        _G.noclipthink = true
                        game:GetService("RunService").Stepped:connect(function()
                            if _G.noclipthink then
                ...
                local J = f:CreateTab("Info", "Credits & Extra Info")
                J:CreateButton("Cloud Hub:tm:", function()
                    if setclipboard then
                        setclipboard("discord.gg/EAFYPZn")
                    end
                end)
                J:CreateButton("Lib: Azure Lib", function()
                    if setclipboard then
                        setclipboard("discord.gg/EAFYPZn")
                    end
                end)
                J:CreateButton("Script: 1temz#7830", function()
                    if setclipboard then
                        setclipboard("discord.gg/EAFYPZn")
                    end
                end)
                J:CreateButton("discord.gg/EAFYPZn", function()
                    if setclipboard then
                        setclipboard("discord.gg/EAFYPZn")
                    end
                end)
                J:CreateButton("Right Shift For Hide / Show", function()
                end)
                local g = game:GetService("UserInputService")
                g.InputBegan:connect(function(K, m)
    ...
    elseif game.PlaceId == 2377868063 then
        if (game:GetService("CoreGui")):FindFirstChild("AzureLibCloudHub") then
            ...
            local d = syn and "Synapse X"
            if d then
                game.StarterGui:SetCore("SendNotification", {
                    Title = "Cloud Hub", Text = "Using: " .. d, Duration = 3
                })
                local e = (loadstring(game:HttpGet("https://raw.githubusercontent.com/1temz/cloudhub/master/library.lua", true)))()
                local f = game:GetService("UserInputService")
                        ...
                        if _G.CheckTeam == false then
                            if c ~= game.Players.LocalPlayer and game.Players.LocalPlayer.Character and c.Character and c.Character:FindFirstChild(_G.AimbottiPart) then
                                if game.Players.LocalPlayer.Character:FindFirstChild(_G.AimbottiPart) then
                                    ...
                                    if checkIfObscured then
                                        local v = {
                                            game.Players.LocalPlayer.Character, c.Character
                                        }
                                        local w = {
                                            game.Players.LocalPlayer.Character[_G.AimbottiPart].Position, c.Character[_G.AimbottiPart].Position
                                        }
                            ...
                            if k.Character and k.Character:FindFirstChild("HumanoidRootPart") and k.Character and (_G.SHOWTRACERS or _G.SHOWNAMES or _G.SHOWPLAYERINS or _G.SHOWPLAYER) and k.Name ~= game.Players.LocalPlayer.Name then
                                ...
                                if _G.SHOWNAMES then
                                    if G[k.Name][3] then
                                        ...
                                        G[k.Name][3].Text = k.Name .. "\10" .. tostring(math.floor((game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position - k.Character.HumanoidRootPart.Position).magnitude))
                ...
                local R = e:CreateTab("Visual", "New Drawing ESP")
                _G.SHOWPLAYER = false
                _G.SHOWPLAYERINS = false
                _G.SHOWTRACERS = false
                _G.SHOWNAMES = false
                R:CreateToggle("Box ESP", function(S)
                    _G.SHOWPLAYER = S
                    _G.SHOWPLAYERINS = S
                end)
                R:CreateToggle("Tracers", function(S)
                    _G.SHOWTRACERS = S
                end)
                local T = e:CreateTab("Combat", "features about combat & fight!")
                T:CreateToggle("Aimbot [RightMouseB]", function(U)
                    if U then
                        accaaambot = true
                    else
                        accaaambot = false
                ...
                T:CreateToggle("Team Check", function(W)
                    _G.CheckTeam = W
                end)
                T:CreateToggle("Damage Aura", function(X)
                ...
                T:CreateButton("Modify Gun", function()
                ...
                local a2 = e:CreateTab("LocalPlayer", "LocalPlayer")
                ...
                local a4 = e:CreateTab("Info", "Credits & Extra Info")
                a4:CreateButton("Cloud Hub:tm:", function()
                    if setclipboard then
                        setclipboard("discord.gg/EAFYPZn")
                    end
                end)
                a4:CreateButton("Lib: Azure Lib", function()
                    if setclipboard then
                        setclipboard("discord.gg/EAFYPZn")
                    end
                end)
                ...
                a4:CreateButton("Right Shift For Hide / Show", function()
                end)
                local f = game:GetService("UserInputService")
                f.InputBegan:connect(function(a5, l)
                    if a5.KeyCode == Enum.KeyCode.RightShift then
                        if game:GetService("CoreGui").AzureLibCloudHub.Enabled == true then
                            game:GetService("CoreGui").AzureLibCloudHub.Enabled = false
                        elseif game:GetService("CoreGui").AzureLibCloudHub.Enabled == false then
                            game:GetService("CoreGui").AzureLibCloudHub.Enabled = true
    ...
    elseif game.PlaceId == 3527629287 then
        ...
        if (game:GetService("CoreGui")):FindFirstChild("InsertedObjects") then
            ...
            if b then
                ...
                co:CreateSlider({
                    text = "Silent Aimbot FOV", bind = "sa-fov", minval = 5, maxval = 100, callback = function(cp)
                        hitboxSettings.setSize = cp / 2
                    end
                })
                local cq = cn:CreateWindow({
                ...
                cq:CreateButton({
                    text = "No Drop", callback = function()
                        for z, A in pairs(getgc(true)) do
                ...
                local cs = {
                    killAura = false, killDrones = false, killSentries = false, killAuraDist = 10, killDelay = 0.2
                }
                cr:CreateToggle({
                    text = "Kill Aura", callback = function(ct)
                        cs.killAura = ct
                                    ...
                                    if L.Character ~= game:GetService("Players").LocalPlayer.Character and L.Character.Humanoid ~= nil then
                                        ...
                                        if cu < cs.killAuraDist then
                                            ...
                                            game.Workspace.__THINGS.__REMOTES["do damage"]:FireServer({
                                                {
                                                    L.Character.Humanoid, math.random(1, 1), math.random(1, 1), L.Character.HumanoidRootPart.Position, false, false, false
                                                }, {
                                                    false, false, false, false, false, math.random(2, 2), math.random(2, 2)
                                                }
                                            })
                                            wait(cs.killDelay)
                                        end
                ...
                cr:CreateSlider({
                    text = "Kill Aura Distance", bind = "Kill-Aura-Distance", minval = 10, maxval = 2500, callback = function(cw)
                        cs.killAuraDist = tonumber(cw)
                    end
                })
                cr:CreateSlider({
                    text = "Kill Delay", bind = "Kill-Aura-Delay", minval = 20, maxval = 100, callback = function(cw)
                        cs.killDelay = tonumber(cw / 100)
                    end
                })
                cr:CreateToggle({
                    text = "Auto-Kill Drones", callback = function(cx)
                        cs.killDrones = cx
                ...
                cr:CreateToggle({
                    text = "Auto-Kill Sentries", callback = function(cx)
                        cs.killSentries = cx
                ...
                cz:CreateToggle({
                    text = "Infinite Jump", callback = function(cw)
                        infinitejumpenabled = cw
                    end
                })
                cz:CreateSlider({
                    text = "JumpPower", bind = "jump-power", minval = 50, maxval = 250, callback = function(cw)
                ...
                local cL = "CloudEncryption_" .. math.random(245, 39923) .. "f7qr" .. math.random(67, 526) .. "xWfhwa" .. math.random(11, 47) .. "gx2f1s" .. math.random(511, 8338) .. "1wFscxzc"
                cF:CreateToggle({
                    text = "Encrpyt Informations", callback = function(cw)
                        if cw then
    ...
    elseif game.PlaceId == 263761432 then
        if (game:GetService("CoreGui")):FindFirstChild("AzureLibCloudHub") then
            ...
            if a then
                game.StarterGui:SetCore("SendNotification", {
                    Title = "Cloud Hub", Text = "Using: " .. a, Duration = 3
                })
                local b = (loadstring(game:HttpGet("https://raw.githubusercontent.com/1temz/cloudhub/master/library.lua", true)))()
                            ...
                            if k.Character and k.Character:FindFirstChild("HumanoidRootPart") and k.Character and (_G.SHOWTRACERS or _G.SHOWNAMES or _G.SHOWPLAYERINS or _G.SHOWPLAYER) and k.Name ~= game.Players.LocalPlayer.Name then
                                ...
                                if _G.SHOWNAMES then
                                    if m[k.Name][3] then
                                        ...
                                        m[k.Name][3].Text = k.Name .. "\10" .. tostring(math.floor((game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position - k.Character.HumanoidRootPart.Position).magnitude))
                ...
                local y = b:CreateTab("Visual", "New Drawing ESP")
                _G.SHOWPLAYER = false
                _G.SHOWPLAYERINS = false
                _G.SHOWTRACERS = false
                _G.SHOWNAMES = false
                y:CreateToggle("Box ESP", function(z)
                    _G.SHOWPLAYER = z
                    _G.SHOWPLAYERINS = z
                end)
                y:CreateToggle("Tracers", function(z)
                    _G.SHOWTRACERS = z
                end)
                local A = b:CreateTab("Farming", "Farming")
                A:CreateButton("Give Egg", function()
                    local B = 0
                    local C = "EggPets"
                    game:GetService("ReplicatedStorage").ShopPurchase:FireServer(B, C)
                end)
                A:CreateTextBox("Give Money", function(D)
                    game.ReplicatedStorage.ShopPurchase:FireServer(-tonumber(D), "Ornament")
                end)
                A:CreateToggle("Level Farm", function(E)
                    _G.islevelfarm = E
                end)
                local F = b:CreateTab("LocalPlayer", "LocalPlayer")
                F:CreateToggle("Infinite Jump", function(G)
                    infinitejumpenabled = G
                end)
                F:CreateToggle("No-Clip", function(H)
                    if H == true then
                        _G.noclipthink = true
                        game:GetService("RunService").Stepped:connect(function()
                            if _G.noclipthink then
                ...
                local I = b:CreateTab("Info", "Credits & Extra Info")
                I:CreateButton("Cloud Hub:tm:", function()
                    if setclipboard then
                        setclipboard("discord.gg/EAFYPZn")
                    end
                end)
                I:CreateButton("Lib: Azure Lib", function()
                    if setclipboard then
                        setclipboard("discord.gg/EAFYPZn")
                    end
                end)
                I:CreateButton("Script: 1temz#7830", function()
                    if setclipboard then
                        setclipboard("discord.gg/EAFYPZn")
                    end
                end)
                I:CreateButton("discord.gg/EAFYPZn", function()
                    if setclipboard then
                        setclipboard("discord.gg/EAFYPZn")
                    end
                end)
                I:CreateButton("Right Shift For Hide / Show", function()
                end)
                game:GetService("RunService").RenderStepped:Connect(function()
                    if _G.islevelfarm then
                        (game:GetService("ReplicatedStorage").EventRemotes:WaitForChild("GhasterBlaster")):FireServer("MiissionSuccess3")
                    end
                end)
                local c = game:GetService("UserInputService")
                c.InputBegan:connect(function(J, h)
                    if J.KeyCode == Enum.KeyCode.RightShift then
                        if game:GetService("CoreGui").AzureLibCloudHub.Enabled == true then
                            game:GetService("CoreGui").AzureLibCloudHub.Enabled = false
                        elseif game:GetService("CoreGui").AzureLibCloudHub.Enabled == false then
                            game:GetService("CoreGui").AzureLibCloudHub.Enabled = true
    ...
    elseif game.PlaceId == 292439477 then
        game.StarterGui:SetCore("SendNotification", {
            Title = "Cloud Hub", Text = "Universal UI", Duration = 3
        })
        getgenv().is_real_paid_cloud = true
        if (game:GetService("CoreGui")):FindFirstChild("InsertedObjects") then
            game.StarterGui:SetCore("SendNotification", {
            ...
            if b then
                ...
                function CheckRay2(m, n, o, p)
                    ...
                    if w and not w:IsDescendantOf(r) then
                        q = false
                        if w.Transparency >= 0.3 or not w.CanCollide and w.ClassName ~= Terrain then
                            l[#l + 1] = w
                        end
                    end
                    return q
                ...
                function as:AddOrUpdateInstance(at, au, av, aw)
                    as.Instances[at] = {
                        ParentInstance = at, Instance = au, Text = av, Color = aw
                    }
                            ...
                            if workspace:FindFirstChild("MoneyPrinters") then
                                for a8, ad in pairs(workspace.MoneyPrinters:GetChildren()) do
                                    ...
                                    if aC and aD and aE then
                                        ...
                                        pcall(as.AddOrUpdateInstance, as, ad, aC, string.format("Money Printer\10Owned by %s\10[%s]", aF, aG), Color3.fromRGB(13, 255, 227))
                                    end
                                end
                            end
                        end
                ...
                function CalculateValue(aV, aW, aX)
                    return aV + math.floor((aW - aV) * aX + 0.5)
                end
                ...
                local a_ = setmetatable({}, {
                    __call = function(a7, ...)
                        ...
                        rawset(a7, aH, setmetatable({
                            Name = b0[1], Text = b0[2], Value = b0[3], DefaultValue = b0[3], AllArgs = b0, Index = U
                        }, {
                ...
                function CheckRay(at, bj, bk, bl)
                    ...
                    if bq and not bq:IsDescendantOf(bn) then
                        bm = false
                        if bq.Transparency >= 0.3 or not bq.CanCollide and bq.ClassName ~= Terrain then
                            a0[#a0 + 1] = bq
                        end
                    end
                    return bm
                        ...
                        for a8, ad in pairs(as.Instances) do
                            if ad.Instance ~= nil and ad.Instance.Parent ~= nil and ad.Instance:IsA("BasePart") then
                                ...
                                bv.Instances.NameTag = bv.Instances.NameTag or (NewDrawing("Text"))({
                                    Size = a_.TextSize, Center = true, Outline = a_.TextOutline, Visible = true
                                })
                                bv.Instances.DistanceTag = bv.Instances.DistanceTag or (NewDrawing("Text"))({
                                    Size = a_.TextSize - 1, Center = true, Outline = a_.TextOutline, Visible = true
                                })
                                        ...
                                        if a_.ShowDistance or a_.ShowHealth or a_.ShowGun then
                                            ...
                                            if a_.ShowGun and not a_.ShowDistance and not a_.ShowHealth then
                                                if ad.Character:FindFirstChildOfClass("Model") then
                                                    bE = bE .. aT("\10Gun : %s", tostring(ad.Character:FindFirstChildOfClass("Model").Name))
                                                end
                                            end
                                            if a_.ShowHealth and a_.ShowDistance and a_.ShowGun then
                                                bE = bE .. aT("Distance : %d ", bj)
                                                bE = bE .. aT("\10Health : %d", hud:getplayerhealth(ad), 100)
                                                if ad.Character:FindFirstChildOfClass("Model") then
                                                    bE = bE .. aT("\10Gun : %s", tostring(ad.Character:FindFirstChildOfClass("Model").Name))
                                                end
                                            end
                ...
                bQ:CreateToggle({
                    text = "Enabled", callback = function(bX)
                        if bX then
                            accaaambot = true
                        else
                            accaaambot = false
                ...
                bQ:CreateToggle({
                    text = "Check Visible", callback = function(bZ)
                        aimVisibleCheck = bZ
                    end
                })
                bQ:CreateToggle({
                    text = "Team Check", callback = function(bZ)
                        checkisTeam = bZ
                    end
                })
                bQ:CreateSlider({
                    text = "Smoothness", bind = "Aimbot-Smoothness", minval = 0, maxval = 6, callback = function(b_)
                        if b_ == 6 then
                            a.XPos = 0.1
                        elseif b_ == 5 then
                            a.XPos = 0.2
                ...
                bR:CreateToggle({
                    text = "Enabled", callback = function(c2)
                        c0.isEnabled = c2
                    end
                })
                bR:CreateSlider({
                    text = "Delay", bind = "Trigger-Delay", minval = 0, maxval = 100, callback = function(c3)
                        c0.Delay = c3 / 100
                    end
                })
                d.circleRadius = 50
                ...
                bS:CreateSlider({
                    text = "Transparency", bind = "Circle-Transparency", minval = 0, maxval = 50, callback = function(c7)
                        d.circleTransparency = c7 / 100
                    end
                })
                bS:CreateSlider({
                    text = "Radius", bind = "Circle-Radius", minval = 50, maxval = 500, callback = function(c8)
                        d.circleRadius = c8
                    end
                })
                d.circleNumSides = 10
                bS:CreateSlider({
                    text = "NumSides", bind = "Circle-NumSides", minval = 10, maxval = 100, callback = function(c9)
                        d.circleNumSides = c9
                    end
                })
                bU:CreateToggle({
                    text = "Enabled", callback = function(ca)
                        a_.Enabled = ca
                    end
                })
                bU:CreateToggle({
                    text = "Show Boxes", callback = function(ca)
                        a_.ShowBoxes = ca
                    end
                })
                bU:CreateToggle({
                    text = "Show Tracers", callback = function(ca)
                        a_.ShowTracers = ca
                    end
                })
                if not is_sirhurt_closure then
                    bU:CreateToggle({
                        text = "Show Names", callback = function(ca)
                            a_.ShowName = ca
                        end
                    })
                    bU:CreateToggle({
                        text = "Show Distance", callback = function(ca)
                            a_.ShowDistance = ca
                        end
                    })
                    bW:CreateToggle({
                        text = "Show Guns", callback = function(ca)
                            a_.ShowGun = ca
                        end
                    })
                end
                bV:CreateToggle({
                    text = "Show Team", callback = function(ca)
                        a_.ShowTeam = ca
                    end
                })
                bV:CreateToggle({
                    text = "Show Team-Color", callback = function(ca)
                        a_.ShowTeamColor = ca
                    end
                })
                bW:CreateSlider({
                    text = "Max Distance", bind = "Max-Distance", minval = 250, maxval = 2500, callback = function(cb)
                        a_.MaxDistance = cb
                    end
                })
                bW:CreateToggle({
                    text = "Check Visible", callback = function(ca)
                        a_.VisCheck = ca
                    end
                })
                ...
                ce:CreateToggle({
                    text = "Encrpyt Informations", callback = function(cl)
                        if cl then
                            game:GetService("Players").LocalPlayer.UserId = cg
                            game:GetService("Players").LocalPlayer.DisplayName = ci
                            game:GetService("Players").LocalPlayer.Name = ck
    ...
    elseif game.PlaceId == 3233893879 then
        ...
        if (game:GetService("CoreGui")):FindFirstChild("InsertedObjects") then
            ...
            local c = syn and "Synapse X"
            if c then
                game.StarterGui:SetCore("SendNotification", {
                    Title = "Cloud Hub", Text = "Using: " .. c, Duration = 3
                })
                ...
                local o = {
                    BadBusiness = {
                        SilentAimbot = {
                            Enabled = false, UseFov = false, ShowFov = false, TeamCheck = false, VisibilityCheck = false, HitChance = 100, HitPart = "Head"
                        }
                    }, Universal = {
                        Visuals = {
                            Enabled = false, Tracers = false, Distance = false, Health = false, Gun = false, HeadDot = false, Color = {
                                Red = 255, Green = 255, Blue = 255
                            }
                        }, Aimbot = {
                            Enabled = false, UseFov = false, TeamCheck = false, VisibilityCheck = false, Smoothing = {
                ...
                r:CreateToggle({
                    text = "Enabled", callback = function(s)
                        o.BadBusiness.SilentAimbot.Enabled = s
                    end
                })
                r:CreateToggle({
                    text = "Use Fov", callback = function(s)
                        o.BadBusiness.SilentAimbot.UseFov = s
                    end
                })
                r:CreateToggle({
                    text = "Team Check", callback = function(s)
                        o.BadBusiness.SilentAimbot.TeamCheck = s
                    end
                })
                r:CreateToggle({
                    text = "Visibility Check", callback = function(s)
                        o.BadBusiness.SilentAimbot.VisibilityCheck = s
                    end
                })
                r:CreateSlider({
                    text = "Hit Chance", minval = 100, maxval = 0, callback = function(s)
                ...
                t:CreateButton({
                    text = "No Recoil", callback = function(s)
                        for m, n in next, getgc(true) do
                            if type(n) == "table" then
                ...
                t:CreateButton({
                    text = "No Spread", callback = function(s)
                ...
                t:CreateButton({
                    text = "No Fire Rate", callback = function(s)
                        for m, n in next, getgc(true) do
                            if type(n) == "table" then
                ...
                t:CreateButton({
                    text = "Fast Reload", callback = function(s)
                        for m, n in next, getgc(true) do
                            if type(n) == "table" then
                ...
                V:CreateSlider({
                    text = "Red", bind = "RGB-R", minval = 0, maxval = 255, callback = function(W)
                        o.Universal.Visuals.Color.Red = W
                    end
                })
                V:CreateSlider({
                    text = "Green", bind = "RGB-G", minval = 0, maxval = 255, callback = function(W)
                        o.Universal.Visuals.Color.Green = W
                    end
                })
                V:CreateSlider({
                    text = "Blue", bind = "RGB-B", minval = 0, maxval = 255, callback = function(W)
                        o.Universal.Visuals.Color.Blue = W
                    end
                })
                P:CreateToggle({
                    text = "Enabled", callback = function(X)
                        if X then
                            accaaambot = true
                        else
                            accaaambot = false
                ...
                P:CreateToggle({
                    text = "Team Check", callback = function(Y)
                        checkisTeam = Y
                    end
                })
                P:CreateSlider({
                    text = "Smoothness", bind = "Aimbot-Smoothness", minval = 0, maxval = 9, callback = function(Z)
                        if Z == 9 then
                            b.XPos = 0.1
                        elseif Z == 8 then
                            b.XPos = 0.2
                ...
                Q:CreateToggle({
                    text = "Enabled", callback = function(a1)
                        _.isEnabled = a1
                    end
                })
                Q:CreateSlider({
                    text = "Delay", bind = "Trigger-Delay", minval = 0, maxval = 100, callback = function(a2)
                        _.Delay = a2 / 100
                    end
                })
                e.circleRadius = 50
                ...
                R:CreateSlider({
                    text = "Transparency", bind = "Circle-Transparency", minval = 0, maxval = 50, callback = function(a6)
                        e.circleTransparency = a6 / 100
                    end
                })
                R:CreateSlider({
                    text = "Radius", bind = "Circle-Radius", minval = 50, maxval = 500, callback = function(a7)
                        e.circleRadius = a7
                    end
                })
                e.circleNumSides = 10
                R:CreateSlider({
                    text = "NumSides", bind = "Circle-NumSides", minval = 10, maxval = 100, callback = function(a8)
                        e.circleNumSides = a8
                    end
                })
                local a9 = {}
                ...
                T:CreateToggle({
                    text = "Show Tracers", callback = function(s)
                        o.Universal.Visuals.Tracers = s
                    end
                })
                T:CreateToggle({
                    text = "Show HeadDot", callback = function(s)
                        o.Universal.Visuals.HeadDot = s
                    end
                })
                if not is_sirhurt_closure then
                    T:CreateToggle({
                        text = "Show Health", callback = function(s)
                            o.Universal.Visuals.Health = s
                        end
                    })
                    T:CreateToggle({
                        text = "Show Distance", callback = function(s)
                            o.Universal.Visuals.Distance = s
                        end
                    })
                    T:CreateToggle({
                        text = "Show Guns", callback = function(s)
                ...
                ak:CreateToggle({
                    text = "Fast Walk", callback = function(s)
                        if s then
                            for m, n in next, getgc(true) do
                                if type(n) == "table" then
                ...
                an:CreateToggle({
                    text = "Encrpyt Informations", callback = function(au)
                        if au then
        ...
        if (game:GetService("CoreGui")):FindFirstChild("InsertedObjects") then
            ...
            if b then
                ...
                c4:CreateToggle({
                    text = "Show Team", callback = function(ck)
                        b6.ShowTeam = ck
                    end
                })
                c4:CreateToggle({
                    text = "Show Team-Color", callback = function(ck)
                        b6.ShowTeamColor = ck
                    end
                })
                c5:CreateSlider({
                ...
                local cu = "CloudEncryption_" .. math.random(245, 39923) .. "f7qr" .. math.random(67, 526) .. "xWfhwa" .. math.random(11, 47) .. "gx2f1s" .. math.random(511, 8338) .. "1wFscxzc"
                co:CreateToggle({
                    text = "Encrpyt Informations", callback = function(cv)
                        if cv then
                            game:GetService("Players").LocalPlayer.UserId = cq
                            game:GetService("Players").LocalPlayer.DisplayName = cs
                            game:GetService("Players").LocalPlayer.Name = cu
